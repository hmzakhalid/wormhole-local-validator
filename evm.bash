...
# npx pm2 start 'npx ganache --accounts 11 --chain.chainId 1397 -p 8546 -m "myth like bonus scare over problem client lizard pioneer submit female collect" --block-time 1' --name evm1
...
npm run migrate
# Deploy Test Tokens to EVMChain 0
# npx truffle exec scripts/deploy_test_token.js
# # Register EVM Chain 0 on Wormhole
# npx truffle exec scripts/register_all_chains.js
